...
public class PetrolPumpFragment extends Fragment {
    ...
    private void getATMS(String pagetoken) {
        String url = String.format(Utilities.GET_GAS_STATION_BY_LOCATION, "39.260501", "-76.699731", Utilities.GOOGLEPLACES_API_KEY, pagetoken);  //TODO Resolve Bug when Lat/Long has 00 in the end
